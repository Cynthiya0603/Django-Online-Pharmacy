...
# Now, you can safely use BASE_DIR to construct paths
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
STATIC_URL = '/static/'
MEDIA_URL = '/media/'  # URL path for media files
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  

# Other settings like STATICFILES_DIRS
STATICFILES_DIRS = [
...
SECRET_KEY = 'django-insecure-24!8q1_3j4x=5xb6-uvr8o&kqzd@a*l@3cc8o)52iv5nkoi4=n'
